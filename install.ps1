...
.PARAMETER EnableWebUi
    Enable the optional secured browser form for AD admins in the generated
    configuration (requires IIS Windows Authentication hosting).
